...
var FWDEVPThumbnailsPreview = function(
		...
		_s.setupCanvas = function(){
			...
			_s.canvas_do.getStyle().backroundColor = '#FF0000';
				...
				for(var i=0; i<_s.vtt_ar.length; i++){
					...
					if(start <= duration  && end > duration ){
						...
						if(imgSrc != _s.prevImgSrc){
							_s.mainHolder_do.getStyle().background = 'url("' +imgSrc + '") no-repeat center center';
							_s.mainHolder_do.getStyle().backgroundSize = "cover";
