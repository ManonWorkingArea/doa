...
var FWDEVPATB = function(
		...
		_s.init = function(){
			...
			if(controller.repeatBackground_bl){
				_s.mainHolder_do.getStyle().background = "url('" + controller.controllerBkPath_str +  "')";
			}else{
		...
		_s.setupLeftAndRight = function(){
			...
			_s.leftText_do = new FWDEVPDisplayObject("div");
			...
			_s.leftText_do.getStyle().backgroundColor = _s.timeBackgroundColor;
			_s.leftText_do.getStyle().fontSmoothing = "antialiased";
			_s.leftText_do.getStyle().webkitFontSmoothing = "antialiased";
			_s.leftText_do.getStyle().textRendering = "optimizeLegibility";
			_s.leftText_do.setInnerHTML("00:00");
			_s.mainHolder_do.addChild(_s.leftText_do);

			_s.rightText_do = new FWDEVPDisplayObject("div");
			...
			_s.rightText_do.getStyle().backgroundColor = _s.timeBackgroundColor;
			_s.rightText_do.getStyle().fontSmoothing = "antialiased";
			_s.rightText_do.getStyle().webkitFontSmoothing = "antialiased";
			_s.rightText_do.getStyle().textRendering = "optimizeLegibility";
