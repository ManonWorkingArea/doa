                ...
                if(posttestArray !== null && posttestArray !== ''  && posttestArray !==undefined) {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            {
                                var showscore = "<p class='post-meta'>📣 <strong>ประกาศผลสอบ</strong> วันที่ 2 มิ.ย. 65 เวลา 09:00 น. โดยตรวจสอบคะแนนของตนเองด้วยการ login เข้าสู่ระบบอบรมปกติ <span class='text-danger'> (** หากครบกำหนดเวลาแล้วผลการอบรมยังไม่แสดง ให้ทำการออกจากระบบและเข้าสู่ระบบอีกครั้ง **)</span></p>" 
