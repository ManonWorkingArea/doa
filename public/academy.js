            ...
            if(index<0){
                ...
                "<div class='col-md-12 mt-2 pt-2 pt-sm-0'>"
                    +"<div class='card blog rounded shadow'>"
                        +"<a href='javascript:void(0);'>"
                            +"</a><div class='card-body content'><a href='javascript:void(0);'>"
                                +"</a><h5><a href='javascript:void(0);'></a><span class='bill-title-small'><i class='uil uil-file-bookmark-alt'></i> แบบทดสอบรอบพิเศษ</span></br><a href='javascript:void(0);' class='card-title title text-dark'>หลักสูตรผู้ควบคุมการขายวัตถุอันตรายทางการเกษตร รุ่น 2 (แบบทดสอบรอบพิเศษ)</a></h5>"
                                +"<p class='post-meta'>วันที่ 26 มิ.ย.65 ตั้งแต่ 07:00 เริ่มสอบ เวลา 08:00-12:00 น.</p>"
                                +"<a href='exam-posttest-3-XG6eCQLYIx.html?session=215&mode=posttest' class='btn btn-lg btn-danger w-100'> ทำแบทดสอบ <i class='uil uil-angle-right-b'></i></a>"
                            +"</div>"
                    +"</div>"
                +"</div>"
                );
                        ...
                        if(result_2.data.info.exam =="รอบที่ 1 วันที่ 15 - 16 ส.ค.65")
                        {
                            ...
                            if(posttestArray !== null && posttestArray !== ''  && posttestArray !==undefined) {
                                ...
                                "<tr class='topic-processing' id='exam-pretest'>"
                                    +"<th class='p-3'>"
                                        +"<div class='align-items-center'>"
                                            +"<p class='mb-0 d-inline fw-normal topic-name-list h6'><a href='external.html?session=" + course + "&target=exam-posttest-1-TAF7eX65i7&document=posttest_1&mode=posttest' class='topic-name-title'>คลิ๊กทำข้อสอบ</a></p>"
