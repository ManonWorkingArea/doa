                ...
                "<tr class='topic-" + item.status + "' id='" + item.code + "'>"
                    +"<th class='p-3'>"
                        +"<div class='align-items-center'>"
                            ...
                            +"<p class='mb-0 d-inline fw-normal h6 ms-1'><a href='course.html?token=" + item.url + "' class='' title='" + item.tip + "' data-bs-toggle='tooltip' data-bs-placement='top'>" + item.title + "</a></p>"
